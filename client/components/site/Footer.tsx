      ...
      <div className="container grid gap-6 py-10 md:grid-cols-3">
        <div>
          <div className="mb-3 inline-flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-white/90">Jefferson Felix</span>
          </div>
        ...
        <div className="flex items-center gap-3 md:justify-end">
          ...
          <a href="#" aria-label="GitHub" className="rounded-md p-2 text-white/70 hover:bg-white/5 hover:text-white">
            <Github className="h-5 w-5" />
          </a>
          <a href="#" aria-label="LinkedIn" className="rounded-md p-2 text-white/70 hover:bg-white/5 hover:text-white">
            <Linkedin className="h-5 w-5" />
          </a>
        </div>
      </div>
      <div className="border-t border-white/10 py-4 text-center text-xs text-white/60">
        © {new Date().getFullYear()} Jefferson Felix. Todos os direitos reservados.
      </div>
    </footer>
  );
}
